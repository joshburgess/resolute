//! Optional Prometheus metrics for stalwart.
//!
...
///
/// ```ignore
/// let metrics = stalwart::metrics::snapshot();
...
pub fn gather() -> String {
    ...
    format!(
        "# HELP stalwart_queries_total Total queries executed.\n\
         # TYPE stalwart_queries_total counter\n\
         stalwart_queries_total {}\n\
         # HELP stalwart_query_errors_total Total query errors.\n\
         # TYPE stalwart_query_errors_total counter\n\
         stalwart_query_errors_total {}\n\
         # HELP stalwart_query_duration_us_avg Average query duration in microseconds.\n\
         # TYPE stalwart_query_duration_us_avg gauge\n\
         stalwart_query_duration_us_avg {}\n\
         # HELP stalwart_executes_total Total execute statements.\n\
         # TYPE stalwart_executes_total counter\n\
         stalwart_executes_total {}\n\
         # HELP stalwart_execute_errors_total Total execute errors.\n\
         # TYPE stalwart_execute_errors_total counter\n\
         stalwart_execute_errors_total {}\n\
         # HELP stalwart_pool_checkouts_total Total pool checkouts.\n\
         # TYPE stalwart_pool_checkouts_total counter\n\
         stalwart_pool_checkouts_total {}\n\
         # HELP stalwart_pool_timeouts_total Total pool checkout timeouts.\n\
         # TYPE stalwart_pool_timeouts_total counter\n\
         stalwart_pool_timeouts_total {}\n",
        m.query_count,
        m.query_error_count,
        avg_us,
        m.execute_count,
